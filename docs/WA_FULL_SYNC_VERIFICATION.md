...
| Entity        | WA Source | ClubOS DB | Status |
|---------------|-----------|-----------|--------|
...
All skipped due to missing last name (required field in ClubOS):
...
### Membership Status Distribution (ClubOS)
...
### Membership Tier Distribution (ClubOS)
...
| waMembershipLevelRaw | Count | ClubOS Mapping |
|----------------------|-------|----------------|
...
*Report generated by ClubOS WA Importer analysis. No database writes were made during this verification.*
