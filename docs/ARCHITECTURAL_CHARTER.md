...
- [Intent to Rendering Contract](./ARCH/INTENT_TO_RENDERING_CONTRACT.md) — How intent maps to presentation

See also: [Core Trust Surface](./ARCH/CORE_TRUST_SURFACE.md) *(forthcoming—will consolidate invariants across all contracts)*
