    ...
    <div data-test-id="hero-block-editor">
      ...
      <Field label="Subtitle">
        <input
          ...
          onChange={(e) => updateData({ subtitle: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
      ...
      <Field label="Background Image URL">
        <input
          ...
          onChange={(e) => updateData({ backgroundImage: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
      ...
      <Field label="CTA Button Text">
        <input
          ...
          onChange={(e) => updateData({ ctaText: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
      ...
      <Field label="CTA Button Link">
        <input
          ...
          onChange={(e) => updateData({ ctaLink: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
          placeholder="/about"
        />
    ...
    <div data-test-id="image-block-editor">
      ...
      <Field label="Caption">
        <input
          ...
          onChange={(e) => updateData({ caption: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
      ...
      <Field label="Link URL">
        <input
          ...
          onChange={(e) => updateData({ linkUrl: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
          placeholder="Optional: make image clickable"
        />
      </Field>
      <Field label="Alignment">
        <select
        ...
        {block.data.cards.map((card, index) => (
          ...
          >
            ...
            <textarea
              ...
              onChange={(e) => updateCard(index, { description: e.target.value || undefined })}
              disabled={disabled}
    ...
    <div data-test-id="event-list-block-editor">
      <Field label="Section Title">
        <input
          type="text"
          value={block.data.title || ""}
          onChange={(e) => updateData({ title: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
      ...
      <Field label="Layout">
        <select
          ...
          onChange={(e) => updateData({ layout: e.target.value as "list" | "cards" | "calendar" })}
          disabled={disabled}
          style={selectStyle}
        >
      ...
      <Field label="Show Past Events">
        <label style={{ display: "flex", alignItems: "center", gap: "8px", cursor: "pointer" }}>
          <input
            type="checkbox"
            checked={block.data.showPastEvents || false}
            onChange={(e) => updateData({ showPastEvents: e.target.checked })}
            disabled={disabled}
          />
    ...
    <div data-test-id="gallery-block-editor">
      ...
      <Field label="Enable Lightbox">
        <label style={{ display: "flex", alignItems: "center", gap: "8px", cursor: "pointer" }}>
          <input
            type="checkbox"
            checked={block.data.enableLightbox ?? true}
    ...
    <div data-test-id="contact-block-editor">
      ...
      <Field label="Description">
        <textarea
          ...
          disabled={disabled}
          style={{ ...inputStyle, minHeight: "60px", resize: "vertical" }}
          placeholder="Optional description above the form"
        />
      </Field>
      <Field label="Recipient Email">
        <input
          type="email"
          value={block.data.recipientEmail}
          onChange={(e) => updateData({ recipientEmail: e.target.value })}
          disabled={disabled}
          style={inputStyle}
          placeholder="info@example.com"
          data-test-id="contact-recipient-input"
        />
      </Field>
      <Field label="Submit Button Text">
        <input
          ...
          onChange={(e) => updateData({ submitText: e.target.value || undefined })}
          disabled={disabled}
          style={inputStyle}
    ...
    <div data-test-id="cta-block-editor">
      ...
      <Field label="Link URL">
        <input
          ...
          style={inputStyle}
          placeholder="/signup"
          data-test-id="cta-link-input"
        />
      </Field>
      <Field label="Style">
        <select
          value={block.data.style || "primary"}
          onChange={(e) => updateData({ style: e.target.value as "primary" | "secondary" | "outline" })}
          disabled={disabled}
          style={selectStyle}
        >
      ...
      <Field label="Size">
        <select
          ...
          onChange={(e) => updateData({ size: e.target.value as "small" | "medium" | "large" })}
          disabled={disabled}
          style={selectStyle}
        >
    ...
    <div data-test-id="divider-block-editor">
      <Field label="Style">
        <select
          ...
          onChange={(e) => updateData({ style: e.target.value as "solid" | "dashed" | "dotted" })}
          disabled={disabled}
          style={selectStyle}
        >
      ...
      <Field label="Width">
        <select
          ...
          onChange={(e) => updateData({ width: e.target.value as "full" | "half" | "quarter" })}
          disabled={disabled}
          style={selectStyle}
        >
    ...
    <div data-test-id="spacer-block-editor">
      <Field label="Height">
        <select
          ...
          onChange={(e) => updateData({ height: e.target.value as "small" | "medium" | "large" })}
          disabled={disabled}
          style={selectStyle}
        >
...
export function BlockEditor({ block, onChange, disabled }: { block: Block; onChange: (block: Block) => void; disabled?: boolean }) {
  switch (block.type) {
    case "hero":
      return <HeroBlockEditor block={block} onChange={onChange as (b: HeroBlock) => void} disabled={disabled} />;
    case "text":
      return <TextBlockEditor block={block} onChange={onChange as (b: TextBlock) => void} disabled={disabled} />;
    case "image":
      return <ImageBlockEditor block={block} onChange={onChange as (b: ImageBlock) => void} disabled={disabled} />;
    case "cards":
      return <CardsBlockEditor block={block} onChange={onChange as (b: CardsBlock) => void} disabled={disabled} />;
    case "event-list":
      return <EventListBlockEditor block={block} onChange={onChange as (b: EventListBlock) => void} disabled={disabled} />;
    case "gallery":
      return <GalleryBlockEditor block={block} onChange={onChange as (b: GalleryBlock) => void} disabled={disabled} />;
    case "faq":
      return <FaqBlockEditor block={block} onChange={onChange as (b: FaqBlock) => void} disabled={disabled} />;
    case "contact":
      return <ContactBlockEditor block={block} onChange={onChange as (b: ContactBlock) => void} disabled={disabled} />;
    case "cta":
      return <CtaBlockEditor block={block} onChange={onChange as (b: CtaBlock) => void} disabled={disabled} />;
    case "divider":
      return <DividerBlockEditor block={block} onChange={onChange as (b: DividerBlock) => void} disabled={disabled} />;
    case "spacer":
      return <SpacerBlockEditor block={block} onChange={onChange as (b: SpacerBlock) => void} disabled={disabled} />;
    default:
