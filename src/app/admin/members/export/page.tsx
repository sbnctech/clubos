...
// Demo data for preview and recent exports
const DEMO_MEMBERS = [
    ...
    <div data-test-id="member-export-page" style={{ padding: "24px", maxWidth: "1200px" }}>
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFilters({ ...filters, status: e.target.value as ExportFilter["status"] })}
          ...
          >
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                ...
                data-test-id="format-csv"
                style={{
                  flex: 1,
                  padding: "12px",
                  fontSize: "14px",
                  fontWeight: 500,
                  backgroundColor: exportFormat === "csv" ? "#dbeafe" : "white",
                  color: exportFormat === "csv" ? "#1e40af" : "#374151",
                  border: `2px solid ${exportFormat === "csv" ? "#2563eb" : "#e5e7eb"}`,
                  borderRadius: "8px",
                  cursor: "pointer",
                }}
              >
              ...
              <button
                ...
                data-test-id="format-excel"
                style={{
                  flex: 1,
                  padding: "12px",
                  fontSize: "14px",
                  fontWeight: 500,
                  backgroundColor: exportFormat === "excel" ? "#dbeafe" : "white",
                  color: exportFormat === "excel" ? "#1e40af" : "#374151",
                  border: `2px solid ${exportFormat === "excel" ? "#2563eb" : "#e5e7eb"}`,
                  borderRadius: "8px",
                  cursor: "pointer",
                }}
              >
            ...
            {exportFormat === "excel" && (
              <p style={{ fontSize: "13px", color: "#6b7280", marginTop: "8px" }}>
                Excel export coming soon. CSV export is fully functional.
              </p>
            )}
          </div>
                  ...
                  <thead>
                    <tr>
                      ...
                      {selectedFields.length > 5 && (
                        <th style={{ padding: "8px", borderBottom: "2px solid #e5e7eb", color: "#9ca3af" }}>
                    ...
                    {previewData.map((member, idx) => (
                      <tr key={idx}>
                        {selectedFields.slice(0, 5).map((field) => (
                          ...
                          >
                            {field.id === "joinDate"
                              ? formatClubDate(member.joinDate)
                              : String((member as Record<string, unknown>)[field.id] ?? "-")}
                          </td>
                        ))}
                        {selectedFields.length > 5 && (
                          <td style={{ padding: "8px", borderBottom: "1px solid #f3f4f6", color: "#9ca3af" }}>
                            ...
                          </td>
                        )}
                      </tr>
          ...
          <div style={{ display: "flex", gap: "12px", marginBottom: "24px" }}>
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                color: "white",
                backgroundColor: isExporting || selectedFields.length === 0 ? "#9ca3af" : "#2563eb",
                border: "none",
                borderRadius: "8px",
                cursor: isExporting || selectedFields.length === 0 ? "not-allowed" : "pointer",
              }}
            >
                ...
                >
                  <div>
                    <div style={{ fontSize: "14px", fontWeight: 500, color: "#1f2937" }}>
                      {formatClubDate(exp.date)}
                    </div>
                    <div style={{ fontSize: "13px", color: "#6b7280" }}>
                      {exp.recordCount} records · {exp.format} · {exp.filters}
                    </div>
                  </div>
                  <button
                    type="button"
      ...
      {showScheduleModal && (
        ...
        >
          ...
          >
            <h2 style={{ fontSize: "20px", fontWeight: 600, color: "#1f2937", margin: "0 0 16px" }}>
              Schedule Recurring Export
            </h2>
            <p style={{ color: "#6b7280", marginBottom: "16px" }}>
              Set up automatic exports that will be sent to your email on a regular schedule.
            </p>
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <input
                type="email"
                id="schedule-email"
                placeholder="admin@sbnewcomers.org"
                style={{
                  width: "100%",
                  padding: "8px 12px",
                  fontSize: "14px",
            ...
            >
              <p style={{ fontSize: "13px", color: "#92400e", margin: 0 }}>
                Scheduled exports coming soon. This feature is currently in development.
              </p>
            </div>
