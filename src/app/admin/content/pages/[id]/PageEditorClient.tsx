    ...
    <div data-test-id="page-editor-root" style={{ padding: "20px", maxWidth: "1400px" }}>
      ...
      >
        <button
          ...
          style={{
            ...
            fontSize: "14px",
            fontWeight: 500,
            backgroundColor: hasUnsavedChanges ? "#0066cc" : "#ccc",
            color: "#fff",
            border: "none",
            borderRadius: "4px",
        ...
        <button
          data-test-id="preview-page-button"
        ...
        {page.status === "DRAFT" && (
          <button
            data-test-id="publish-page-button"
            onClick={handlePublish}
            disabled={saving || hasUnsavedChanges}
            title={hasUnsavedChanges ? "Save changes first" : "Publish page"}
            style={{
              padding: "8px 16px",
              fontSize: "14px",
              fontWeight: 500,
              backgroundColor: hasUnsavedChanges ? "#ccc" : "#060",
              color: "#fff",
              border: "none",
              borderRadius: "4px",
              cursor: saving || hasUnsavedChanges ? "not-allowed" : "pointer",
        ...
        {page.status === "PUBLISHED" && (
          <button
            data-test-id="unpublish-page-button"
        ...
        {page.status !== "ARCHIVED" && (
          <button
            data-test-id="archive-page-button"
      ...
      <div style={{ display: "flex", gap: "24px", marginBottom: "24px" }}>
        ...
        <div style={{ flex: "1 1 150px" }}>
          ...
          <select
            value={visibility}
            onChange={(e) => setVisibility(e.target.value as "PUBLIC" | "MEMBERS_ONLY" | "ROLE_RESTRICTED")}
