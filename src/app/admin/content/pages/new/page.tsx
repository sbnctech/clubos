...
export default function AdminNewPagePage() {
  ...
  return (
    <div data-test-id="new-page-root" style={{ padding: "20px", maxWidth: "1400px" }}>
      ...
      >
        <button
          data-test-id="create-page-button"
          ...
          style={{
            ...
            fontSize: "14px",
            fontWeight: 500,
            backgroundColor: !title.trim() || !slug.trim() ? "#ccc" : "#0066cc",
            color: "#fff",
            border: "none",
            borderRadius: "4px",
      ...
      <div style={{ display: "flex", gap: "24px", marginBottom: "24px" }}>
        <div style={{ flex: "1 1 300px" }}>
          ...
          <input
            ...
            data-test-id="new-page-title-input"
        ...
        <div style={{ flex: "1 1 200px" }}>
          ...
          <input
            ...
            data-test-id="new-page-slug-input"
        ...
        <div style={{ flex: "1 1 150px" }}>
          ...
          <select
            ...
            data-test-id="new-page-visibility-select"
            style={{
              width: "100%",
              padding: "8px 10px",
              fontSize: "14px",
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <textarea
          ...
          data-test-id="new-page-description-input"
          style={{
            width: "100%",
            padding: "8px 10px",
            fontSize: "14px",
